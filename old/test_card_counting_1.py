...
def read_value(filepath, row_x, column_y, TC): #Basic strategy + modifies
  if (filepath == "S2_1.txt" and TC < -2 and row_x == 13 and column_y == 3):
    return "H"
  elif (filepath == "S2_1.txt" and TC < -1 and ((row_x == 13 and column_y == 2) or (row_x == 16 and column_y == 9))):
    return "H"
  elif (filepath == "S2_1.txt" and TC < 0 and ((row_x == 12 and column_y == 4) or (row_x == 15 and column_y == 10))):
    return "H"
  elif (filepath == "S2_1.txt" and TC > 0 and row_x == 16 and column_y == 10):
    return "S"
  elif (filepath == "S2_1.txt" and TC > 1 and ((row_x == 11 and column_y == 11) or (row_x == 9 and column_y == 2))):
    return "D"
  elif (filepath == "S3_1.txt" and TC > 1 and row_x == 6 and column_y == 2):
    return "D"  
  elif (filepath == "S3_1.txt" and TC > 1 and ((row_x == 8 and column_y == 5) or (row_x == 8 and column_y == 6))):
    return "G"
  elif (filepath == "S2_1.txt" and TC > 2 and row_x == 8 and column_y == 6):
    return "D"
  elif (filepath == "S2_1.txt" and TC > 2 and row_x == 12 and column_y == 3):
    return "S"
  elif (filepath == "S2_1.txt" and TC > 3 and row_x == 12 and column_y == 2):
    return "S"
  elif (filepath == "S2_1.txt" and TC > 3 and row_x == 9 and column_y == 7):
    return "D"
  elif (filepath == "S3_1.txt" and TC > 3 and row_x == 8 and column_y == 4):
    return "G"
  elif (filepath == "S2_1.txt" and TC > 4 and ((row_x == 16 and column_y == 9) or (row_x == 15 and column_y == 10))):
    return "S"
  elif (filepath == "S2_1.txt" and TC > 4 and ((row_x == 10 and column_y == 10) or (row_x == 10 and column_y == 11))):
    return "D"
  elif (filepath == "S1_1.txt" and TC > 4 and row_x == 10 and column_y == 6):
    return "Y"
  elif (filepath == "S1_1.txt" and TC > 5 and row_x == 10 and column_y == 5):
    return "Y"
  elif (filepath == "S1_1.txt" and TC > 6 and row_x == 10 and column_y == 4):
    return "Y"
  else:
  ...
  while True:
    ...
    while True: #Additional cards if hit
      ...
      if (c != 11): #New card is not an ace with value 11
        s += c
        tot += c
        value = read_value("S2_1.txt", row_x = s, column_y = d1, TC = TC)
        if (value == "H"): #Hit
          pass
        elif (value == "S"): #Stand
          break
      ...
      if (c == 11): #New card is an ace with possible value 11
        value = read_value("S3_1.txt", row_x = s, column_y = d1, TC = TC)
        if (value == "H"): #Hit
          pass
        elif (value == "S"): #Stand
          tot += c
...
while counter < 100000: #Cycle every time dealer shuffles deck
  ...
  while True: #Cycle every time a play is made
    ...
    if ((d1 + d2) == 21 and (c1 + c2) != 21):
      ...
      #Scenario 3
      if (c1 == c2):
          value = read_value("S1_1.txt", row_x = c1, column_y = d1, TC = TC)
          if (value == "Y"): #Split
            balance -= bet
            nd = 1
            for x in range (2):
