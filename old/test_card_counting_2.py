...
def read_value(filepath, row_x, column_y, TC): #Basic strategy + modifies
  if (filepath == "S2_2.txt" and TC < -1 and row_x == 13 and column_y == 2):
    return "H"
  elif (filepath == "S2_2.txt" and TC < 0 and row_x == 12 and column_y == 4):
    return  "H"
  elif (filepath == "S2_2.txt" and TC > 0 and row_x == 16 and column_y == 10):
    return  "S"
  elif (filepath == "S2_2.txt" and TC > 1 and ((row_x == 9 and column_y == 2) or (row_x == 11 and column_y == 11))):
    return  "D"
  elif (filepath == "S2_2.txt" and TC > 2 and row_x == 12 and column_y == 3):
    return  "S"
  elif (filepath == "S2_2.txt" and TC > 2 and row_x == 8 and column_y == 6):
    return  "D"
  elif (filepath == "S2_2.txt" and TC > 3 and row_x == 9 and column_y == 7):
    return  "D"
  elif (filepath == "S2_2.txt" and TC > 3 and row_x == 12 and column_y == 2):
    return  "S"
  elif (filepath == "S2_2.txt" and TC > 4 and ((row_x == 10 and column_y == 10) or (row_x == 10 and column_y == 11))):
    return  "D"
  elif (filepath == "S2_2.txt" and TC > 4 and ((row_x == 15 and column_y == 10) or (row_x == 16 and column_y == 9))):
    return  "S"
  elif (filepath == "S3_2.txt" and TC > 1 and row_x == 6 and column_y == 2):
    return  "D"
  elif (filepath == "S3_2.txt" and TC > 1 and ((row_x == 8 and column_y == 5) or (row_x == 8 and column_y == 6))):
    return  "G"
  elif (filepath == "S3_2.txt" and TC > 1 and row_x == 8 and column_y == 4):
    return  "G"
  elif (filepath == "S1_2.txt" and TC > 4 and row_x == 10 and column_y == 6):
    return  "Y"
  elif (filepath == "S1_2.txt" and TC > 5 and row_x == 10 and column_y == 5):
    return  "Y"
  elif (filepath == "S1_2.txt" and TC > 6 and row_x == 10 and column_y == 4):
    return  "Y"
  else:
...
def scenario_1(balance, bet, value, s, d1, tot, RC, TC, i, decks, cards, nd): #Scenario 1
  while True:
    if (value == "H"): #Hit
      ...
      if (balance >= bet and nd == 0): #Double
        balance -= bet
        bet *= 2
